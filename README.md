...
### AI Analysis
- **Meeting summary** generated by Bedrock Claude Sonnet 5
...
- **AI briefings** — Sonnet 5 generates SA-focused analysis for each article
...
| AI/ML | Bedrock Claude Sonnet 5, Claude Haiku 4.5, Qwen 3 32B |
...
### AI 분석
- **미팅 요약** — Bedrock Claude Sonnet 5로 자동 요약 생성
...
- **AI 브리핑** — Sonnet 5가 각 기사에 대한 SA 관점 분석 생성
