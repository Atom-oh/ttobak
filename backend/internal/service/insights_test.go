...
func TestListInsights_WithSourceFilter(t *testing.T) {
	...
	resp, err := svc.ListInsights(ctx, "blog", "aws-blog", "", 1, 20)
	if err != nil {
...
func TestListInsights_WithSourceAndServiceFilter(t *testing.T) {
	...
	resp, err := svc.ListInsights(ctx, "blog", "aws-blog", "lambda", 1, 20)
	if err != nil {
		t.Fatalf("ListInsights returned error: %v", err)
	}
...
func TestListInsights_CrossSourceByType(t *testing.T) {
	...
	resp, err := svc.ListInsights(ctx, "blog", "", "", 1, 20)
	if err != nil {
		t.Fatalf("ListInsights returned error: %v", err)
	}
...
func TestListInsights_CrossSource_DefaultType(t *testing.T) {
	...
	resp, err := svc.ListInsights(ctx, "", "", "", 1, 20)
	if err != nil {
		t.Fatalf("ListInsights returned error: %v", err)
	}
...
func TestListInsights_PaginationDefaults(t *testing.T) {
	...
	resp, err := svc.ListInsights(ctx, "blog", "", "", 0, 0)
	if err != nil {
		t.Fatalf("ListInsights returned error: %v", err)
	}
...
func TestListInsights_PaginationDefaults_Negative(t *testing.T) {
	...
	resp, err := svc.ListInsights(ctx, "blog", "", "", -5, -10)
	if err != nil {
		t.Fatalf("ListInsights returned error: %v", err)
	}
...
func TestListInsights_LimitCap(t *testing.T) {
	...
	resp, err := svc.ListInsights(ctx, "blog", "", "", 1, 100)
	if err != nil {
		t.Fatalf("ListInsights returned error: %v", err)
	}
...
func TestListInsights_LimitCapBoundary(t *testing.T) {
	...
	resp, err := svc.ListInsights(ctx, "blog", "", "", 1, 50)
	if err != nil {
		t.Fatalf("ListInsights returned error: %v", err)
	}
	...
	resp, err = svc.ListInsights(ctx, "blog", "", "", 1, 51)
	if err != nil {
		t.Fatalf("ListInsights returned error: %v", err)
	}
...
func TestListInsights_Pagination(t *testing.T) {
	...
	resp, err := svc.ListInsights(ctx, "blog", "", "", 1, 2)
	if err != nil {
	...
	resp, err = svc.ListInsights(ctx, "blog", "", "", 3, 2)
	if err != nil {
	...
	resp, err = svc.ListInsights(ctx, "blog", "", "", 4, 2)
	if err != nil {
...
func TestListInsights_EmptyResult(t *testing.T) {
	...
	resp, err := svc.ListInsights(ctx, "blog", "nonexistent", "", 1, 20)
	if err != nil {
		t.Fatalf("ListInsights returned error: %v", err)
	}
