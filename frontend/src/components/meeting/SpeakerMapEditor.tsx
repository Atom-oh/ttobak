      ...
      {isOpen && (
        <div className="mt-4 space-y-3">
          ...
          <button
            ...
            className="mt-2 px-4 py-2 bg-primary dark:bg-primary text-white dark:text-background-dark rounded-lg text-sm font-semibold disabled:opacity-40 hover:opacity-90 transition-opacity flex items-center gap-2"
          >
            {saving ? (
              <>
