      ...
      <div className="px-4 pb-3">
        ...
        {state === 'not-connected' && (
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg border border-dashed border-slate-300 dark:border-white/15 text-left hover:border-primary/40 hover:bg-primary/5 transition-colors"
          >
