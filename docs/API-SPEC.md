...
> **Current status**: real-time transcription runs client-side via the Browser Web Speech API (`BrowserSpeechRecognition`); translation/summary use REST calls. WebSocket-based Nova Sonic streaming is a v2 goal.
