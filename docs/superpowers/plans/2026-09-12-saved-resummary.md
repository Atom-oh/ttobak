...
context is imported. Missing/currently-unavailable supported document extraction
blocks the request instead of pretending filenames are document evidence.
