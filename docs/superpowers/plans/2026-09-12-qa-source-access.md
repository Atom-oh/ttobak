...
- [x] Run the standalone prerequisite: 134 tests passed.
...
- [x] Move three direct retrieval-engine tests beside `SourceAccess`; retain every handler/model/session integration test for the runtime release.
